...
async def test_answer_initializes_runtime_before_resets_and_graph_invocation(
    ...
    monkeypatch.setattr(
        system, "init_web_search", lambda _cfg: calls.append("web"), raising=False
    )
    monkeypatch.setattr(
        system,
    ...
    monkeypatch.setattr(
        ...
        lambda: calls.append("reset_wd"),
        raising=False,
    )
    monkeypatch.setattr(
        system,
        "reset_web_research_session",
        lambda: calls.append("reset_web"),
        raising=False,
    )
    ...
    monkeypatch.setattr(
        system, "build_mcts_graph", lambda *_a, **_kw: graph, raising=False
    )
