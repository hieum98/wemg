...
from coe.llm.roles import Entity as NEREntity
from coe.retrieval.reranker import Reranker
from coe.retrieval.wikidata import WikidataEntity
...
async def link_entities_llm(
    ...
    """
    from coe.llm.roles import NER, NERInput, execute_role
...
async def link_entities_azure(
    ...
    from coe.llm.roles import Entity as RoleEntity
    entity_dict = {}
    all_entities = []
